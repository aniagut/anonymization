...
def analyze_emotions_on_photo(filename, file_id):
    gaze = GazeTracking()
    ...
    anonymized_path = os.path.join("processing/anonymization", f"{file_id}{extension}")
    ...
    new_image_name = os.path.join("processing/emotions", f"{file_id}{extension}")
